...
[cost, grad] = sparseAutoencoderCost(theta, visibleSize, hiddenSize, lambda, ...
                                     sparsityParam, beta, patches(:, 1:150));
...
fprintf('\n\nDisplayed numerical gradient Vs backprop gradient\n\n');
...
fprintf('\nDont even think of proceeding without getting this right\n\n');
...
options.maxIter = 10^7;   % Maximum number of iterations of L-BFGS to run
options.display = 'on';
options.useMex = 0;
